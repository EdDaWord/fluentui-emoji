...
(`png_icons` by default) and produces 512x512 PNGs by default.
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    switch (arg) {
      ...
      case '--test':
        ...
        break;
      case '--out':
        options.outputDirName = args[++i] || 'png_icons';
        break;
      case '--style': {
      ...
      case '--help':
        ...
        console.log('  --out DIR    Output directory name (default: png_icons)');
